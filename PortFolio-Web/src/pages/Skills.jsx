        ...
        <div className="container px-5 py-14 mx-auto  ">
          <div className="text-center mb-20" data-aos='fade-up'>
            ...
            >
              ...
              fugit molestias, accusantium eius illo consectetur!
            </p>
          </div>
        </div>
        <div
                ...
                >
                  <div className="flex item-center mb-6">
                    <div
                      ...
                      className="w-16 h-16 rounded-xl p-3 flex items-center justify-center group-hover:scale-110 transition-transform duration-100  "
                    >
                      <img
                        src={skill.icon}
                        alt={skill.name}
                  ...
                  <div className="mb-2 flex justify-between items-center ">
                    ...
                    <span
                      style={{
                        background: "linear-gradinet(to right,#f97316,#f59e0b",
                        WebkitBackgroundClip: "text",
                        backgroundClip: "text",
                        color: "transparent",
                      }}
