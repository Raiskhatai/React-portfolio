...
const Contact = ({ DarkMode }) => {
  return (
    <section
      ...
      className="p12 sm:py-16 md:py-20 lg:py-24 overflow-hidden  "
    >
          ...
          <form
            ...
            style={{
              background: DarkMode
                ...
                : "linear-gradient(to right,#ffffff,#f9fafd)",
              borderColor: DarkMode ? "#374151" : "#e5e7eb",
            }}
            className="
            rounded-xl p-4 sm:p-5 md:p-6 lg:p-8 border shadow-lg order-1 lg:order-2
              "
            data-aos="fade-left"
          >
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 mb-3 sm:mb-4 ">
              <input
                ...
                className="w-full px-3 sm:px-4 py-2 sm:py-3 rounded-lg text-sm sm:text-base focus:orange-500 focus:ring-2 
              ...
              <textarea
                ...
                className="w-full px-3 sm:px-4 py-2 sm:py-4 sm:mb-4 rounded-lg text-sm sm:text-base focus:border-orange-500 focus:ring-2 
                  focus:ring-orange-500/20 transition-all "
                required
              />
            <button
